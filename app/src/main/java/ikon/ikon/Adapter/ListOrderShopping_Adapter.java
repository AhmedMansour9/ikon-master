...
public class ListOrderShopping_Adapter extends RecyclerView.Adapter<ListOrderShopping_Adapter.MyViewHolder> {



    private List<ShopOrder> filteredList=new ArrayList<>();
    ...
    public ListOrderShopping_Adapter(List<ShopOrder> phon, Context context){
        filteredList=phon;
        this.con=context;
    }
    ...
    @Override
    public ListOrderShopping_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemordershopping, parent, false);
        return new ListOrderShopping_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ListOrderShopping_Adapter.MyViewHolder holder, final int position) {
