...
public class ListOrdersShopping extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,ListOrderShoppingView{
    ...
    ListOrderShopping_Adapter adapter;
    String Lan;
    SwipeRefreshLayout mSwipeRefreshLayout;
    GridLayoutManager gridLayoutManager;
    CounterPresenter cn;
    ListOrderShopping_Presenter listorderPresenter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_orders_shopping);
        listorderPresenter=new ListOrderShopping_Presenter(this,this);
    ...
    public void Recyclview() {
        recyclerView = findViewById(R.id.recycler_ordersshopping);
        recyclerView.setHasFixedSize(true);
    }

    public void SwipRefresh() {
        mSwipeRefreshLayout = findViewById(R.id.swi);
    ...
    @Override
    public void GetListOrderShopping(List<ShopOrder> list) {
        adapter = new ListOrderShopping_Adapter(list,this);
